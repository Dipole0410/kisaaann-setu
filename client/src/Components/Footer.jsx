    ...
    <footer className="text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          <p className="text-sm">
            Kisan Setu — स्मार्ट खेती, मौसम, योजनाएँ और AI सलाह एक ही
            प्लेटफ़ॉर्म पर।
          </p>
        ...
        <div className="max-w-80">
          ...
          <p className="mt-3 text-sm">
            नई योजनाओं के लिए पंजीकरण करें और होम पर योजना सूची देखें।
          </p>
          ...
          <p className="text-lg text-gray-800 mt-6">अपडेट रहें</p>
          <p className="mt-3 text-sm">
